package com.markeisjones.schools.model;
...
public class School_Info {
    ...
    public School_Info(String dbn, String num_of_sat_test_takers, String sat_critical_reading_avg_score, String sat_math_avg_score, String sat_writing_avg_score, String school_name) {
        this.dbn = dbn;
